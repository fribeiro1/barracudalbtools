...
/**
 * Deletes a real server from a service
 */
@Mojo(name = "delete-real-server")
@SuppressWarnings({ "rawtypes", "unchecked" })
public final class DeleteRealServerMojo extends AbstractMojo {
	/**
	...
	public void execute() {
		...
		try {
			...
			getLog().error("Cannot delete real server from service", e);
		}
